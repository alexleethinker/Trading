...
def fetch_global_prices():
    ...
    columns = '["isin","name","description","logoid","type","close","currency","change","Value.Traded","market_cap_basic","fundamental_currency_code","sector","sector.tr","industry","market","is_primary","exchange","country"]'
    payload = '{"columns":'+ columns +',"filter":[{"left":"typespecs","operation":"has_none_of","right":["etn","etf"]}],"ignore_unknown_fields":false,"price_conversion":{"to_currency":"usd"},"range":[0,1000],"sort":{"sortBy":"market_cap_basic","sortOrder":"desc"},"markets":' + markets + '}'
