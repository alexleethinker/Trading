...
# from investin.Utils.ReportLoader.QwenReportSummary import generate_weekly_qwen_report
...
def start_cronjob():
    ...
    scheduler.add_job(update_spot_data_at_trading_a, 'cron', day_of_week='mon-fri',hour='0-7',minute='0/5',second='30')
    ...
    scheduler.add_job(update_spot_europe_at_trading, 'cron', day_of_week='mon-fri',hour='7-16',minute='0/5',second='30')
    ...
    scheduler.add_job(StockSpotUS().run, 'cron', day_of_week='mon-fri',hour='13-22',minute='0/5')
